...
namespace SolutionJuraganMobil.Model
{
    internal class SUV : Vehicle
    {
        ...
        public SUV(string noPolice, int year, decimal price, int seat, DateOnly transaction, decimal rent,decimal driver) : base(noPolice, year, price, seat, transaction)
        {
            _rent = rent;
            _driver = driver;
            _total = rent + driver;
        ...
        public static decimal IncomeSUV()
        {
            return _totalIncome;
        }
